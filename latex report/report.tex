...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.25]{graphs/top-10-features-in-raw-data.png}
...
\subfigure[]{
\label{Fig.sub.3}
\includegraphics[width=0.3\textwidth]{graphs/statistics1.png}}
\subfigure[]{
\label{Fig.sub.4}
\includegraphics[width=0.3\textwidth]{graphs/statistics2.png}}
\subfigure[]{
\label{Fig.sub.5}
\includegraphics[width=0.3\textwidth]{graphs/statistics3.png}}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.15]{graphs/confusion_matrix.jpeg}
