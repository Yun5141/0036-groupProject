...
\begin{itemize}
\item[-] For H/Not H and A/Not A, this classifier takes HR (Average number of red cards received by the home team in nearly matches) as the most significant feature to determine the winning percentage of home team. In the other words, if a home team did not get any red cards in previous some matches, on average, the winning rate of home team would be about 0.17 higher. \\
~\\
From the rules of football match, if a football player get a red card, he may be banned for next 3 matches, this can be regarded as an disadvantage in matches.\\
